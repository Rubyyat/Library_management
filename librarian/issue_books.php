                        ...
                        <div class="x_content">
                            ...
                            if(isset($_POST["submit1"]))
                            {
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="submit" name="submit2" class="form-control btn btn-default" value="issue books" style="background-color: blue; color: white" required>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            if(isset($_POST["submit2"]))
                            {
                                ...
                                <?php
                                    ...
                                    mysqli_query($link, "insert into issue_books values ('','$_SESSION[enrollment]','$_POST[studentname]','$_POST[studentsem]','$_POST[studentcontact]','$_POST[studentemail]','$_POST[booksname]','$_POST[booksissuedate]','','$_SESSION[username]')");
